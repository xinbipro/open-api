...
## 1. open-api Catalog (example：openapi.xinbipro.com/exchange-open-api)
...
## 2. ws-api Catalog  (example：wss://ws.xinbipro.com/kline-api/ws)
...
/** http request */
        String resultJson = get("https://www.xinbipro.com/exchange-open-api/open/api/get_trades?symbol=btcusdt", params);
